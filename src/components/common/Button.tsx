...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-50 rounded-md flex items-center justify-center';
